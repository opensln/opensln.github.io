let entries = [
  {
    idBox: "023",
    titleBox: "Using the AudioContext from the Web Audio API",
    description:
      "Instantiating the AudioContext. Setting a default frequency. Setting a default beat length. Setting up a loop to trigger notes on the AudioContext time-line at intervals specified by the beat length. Using a switch statement to select a frequency to be played for each particular iteration of the loop. Setting up the envelope for the sound before each sound is triggered with the osc.start method. Setting up a few options in the user interface so that the tempo and start frequency can be selected.",
    techBox: "Web Audio API, JavaScript, HTML & CSS",
    linkBox:
      "<a href='https://plnkr.co/edit/ileKljbawFpdRmbI?preview' target='_blank'>View project.</a>",
  },
  {
    idBox: "022",
    titleBox:
      "Using React Context to Provide Access to State Across Components",
    description:
      'Creating a context.js file to store data in the state after requesting and receiving data by using the axios module. Wrapping all of the component tags with the provider tags in the App.js file. Setting up routes for links using the react-router-dom module. Passing in the id for the lyric search by using "this.props.match.params.id. Using conditional statements to handle missing data.',
    techBox: "React, Node, HTML, JavaScript & CSS",
    linkBox:
      "<a href=https://opensln-lyricapp.netlify.app/ target='_blank'>View project.</a> <p>*currently relies on Cors Anywhere which could be blocked at any-time.</p>",
  },

  {
    ...
    linkBox:
      "<a href=https://plnkr.co/edit/FykmHFS0ZIFN78BZ?preview target='_blank'>View Fetch project.</a> <p><a href=https://plnkr.co/edit/jOxHTy6Yh30y3MVC?preview target='_blank'>View Async/Await project.</a></p> <p><a href=https://plnkr.co/edit/SRpt4l4sCcH8aktso9Bu?preview target='_blank'>View jQuery project.</a></p>",
  },

  {
    ...
    techBox: "React, Node, HTML, JavaScript & CSS",
    linkBox:
      "<a href=https://opensln-whoseddit.netlify.app/ target='_blank'>View the project.</a>",
  },

  {
    ...
    techBox: "React, Node, HTML, JavaScript & CSS",
    linkBox:
      "<a href=https://opensln-todo-react.netlify.app/ target='_blank'>View the project.</a>",
  },

  {
    ...
    linkBox:
      "<a href=https://plnkr.co/edit/4PF0sgWqk6Y5Psx3?preview target='_blank'>View the project.</a>",
  },

  {
    ...
    techBox: "HTML, JavaScript & CSS",
    linkBox:
      "<a href=https://openslnblog.blogspot.com/p/instant-multiplication-grid-generator.html target='_blank'>View the project.",
  },

  {
    ...
    techBox: "C# and Json",
    linkBox:
      "<a href=https://dotnetfiddle.net/vLM8NR target='_blank'>View the project.</a>",
  },
...

  {
    ...
    linkBox:
      "<a href=https://openslnblog.blogspot.com/p/benchmarking-tool.html target='_blank'>View the project.</a>",
  },

  {
    ...
    linkBox:
      "<a href=https://dotnetfiddle.net/p7CFCJ target='_blank'>View the project.</a>",
  },

  {
    idBox: "012",
    titleBox:
      "Using JavaScript to set HTML Attributes in a Multiple-Choice Quiz",
    description:
    ...
    techBox: "HTML, JavaScript & CSS",
    linkBox:
      "<a href=https://danielsmithldn.com/rwa/randomquiz/randomquiz01.html target='_blank'>View the project.</a>",
  },
...

  {
    ...
    techBox: "HTML, JavaScript & CSS",
    linkBox:
      "<a href='https://plnkr.co/edit/SRpt4l4sCcH8aktso9Bu?p=preview&preview' target='_blank'>View the code.</a>",
  },

  {
    ...
    description:
      'Creating a method that returns a number to the "Main" method and sends this to the "View" page using ViewBag. Calling a void method from the "Main" method that writes directly to the "View" usng ViewBag from that method. Adding some CSS styling directly to the View. Click <a href="https://stackoverflow.com/questions/51390971/im-lost-what-happened-to-asp-net-mvc-5" target="_blank">here</a> for a post that clears up some of confusion over the .Net products/frameworks/systems. </td>',
    techBox: "ASP.NET MVC, C#, HTML & CSS",
    linkBox:
      "<a href='https://dotnetfiddle.net/PRJItR' target='_blank'>View the code.</a>",
  },

  {
    ...
    description:
      'Creating methods that each create an array which is returned to the "Main" method. Calling a method from the "Main" method that writes out the items of each array (that were passed in as an arguments) into the console.',
    techBox: "C# (c-sharp)",
    linkBox:
      "<a href='https://dotnetfiddle.net/oQqiVb' target='_blank'>View the code.</a>",
  },

  {
    idBox: "005",
    titleBox:
      "Calling methods that return a string value to the main method in C#",
    description:
      "Calling a set of methods that each assign a line into a variable which is returned to the main method which is then written to the console.",
    techBox: "C# (c-sharp)",
    linkBox:
      "<a href='https://dotnetfiddle.net/G4P3sp' target='_blank'>View the code.</a>",
  },

  {
    ...
    description:
      "Calling a void method from another void method where each method writes it's line to the console.",
    techBox: "C# (c-sharp)",
    linkBox:
      "<a href='https://dotnetfiddle.net/JwJ5F6' target='_blank'>View the code.</a>",
  },

  {
    ...
    linkBox:
      "<a href='https://danielsmithldn.com/rwa/requestingjsondata/requestingjsondata.html' target='_blank'>Site Link</a><br>or<br> <a href='https://plnkr.co/edit/mRKAJOV3ziNSPnR14J0J?p=preview&preview' target='_blank'>View the code.</a>",
  },

  {
    ...
    description:
      "Calling a function from another function and passing a variable as an argument whilst calling this function. This project also displays the scope of local variables. The same variable names were used in each function block to highlight the fact that these variables only applied within their own function blocks.",
    techBox: "HTML & JavaScript",
    linkBox:
      "<a href='https://danielsmithldn.com/rwa/chain_of_functions/fish_alive.html' target='_blank'>Site Link</a><br>or<br> <a href='https://next.plnkr.co/edit/7qXNn7AsoElVJoYnYFeN?p=preview&preview' target='_blank'>View the code.</a>",
  },

  {
    ...
    description:
      "Taking values from input cells and displaying them in a graph.",
    techBox: "HTML, CSS & JavaScript.",
    linkBox:
      "<a href='https://danielsmithldn.com/rwa/pointstographtable/pointstographtable.html' target='_blank'>Site Link</a><br>or<br> <a href='https://next.plnkr.co/edit/RqZLhhszAgKcwm5iXN8l?p=preview&preview' target='_blank'>View the code</a>",
  },
];
